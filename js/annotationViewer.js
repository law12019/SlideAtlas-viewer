...
// The AnnotationLayers have the same viewport as the main view.
...
// TODO:
// I want layerGui to own the tools for interaction,
// but the tools have to be available before the first layer is created.
...
(function () {
  ...
  function AnnotationViewer (parentTileViewer, nercUrl=false, girderItemId=false) {
    ...
    */
    ...
    this.InitializeHelp(this.ParentDiv.parent());
  ...
  AnnotationViewer.prototype.TestUploadFile = function (obj) {
    var self = this;
    girder.rest.restRequest({
  ...
  AnnotationViewer.prototype.TestUploadFile2 = function (obj) {
    var self = this;
    var params;
    if ('file_id' in obj) {
      params = {
  ...
  AnnotationViewer.prototype.TestUploadFile3 = function (obj) {
    var params = {
      'offset': 0,
  ...
  AnnotationViewer.prototype.UpdateCanvasSize = function (viewport) {
    for (var i = 0; i < this.LayerGuis.length; ++i) {
      var layerGui = this.LayerGuis[i];
      var layer = layerGui.Layer;
      if (layer && layer.UpdateCanvasSize) {
        layer.UpdateCanvasSize(viewport);
      }
    }
  };

  AnnotationViewer.prototype.Draw = function () {
    for (var i = 0; i < this.LayerGuis.length; ++i) {
      var layerGui = this.LayerGuis[i];
      var layer = layerGui.Layer;
      if (layer && layer.Draw) {
  ...
  AnnotationViewer.prototype.Reset = function () {
    for (var i = 0; i < this.LayerGuis.length; ++i) {
      var layerGui = this.LayerGuis[i];
      var layer = layerGui.layer;
  ...
  AnnotationViewer.prototype.WithEditingLayerCall = function (callback) {
  ...
  AnnotationViewer.prototype.InitializeHelp = function (parent) {
    var helpDiv = $('<div>')
        .appendTo(parent)
        .css({
          'position': 'absolute',
  ...
  AnnotationViewer.prototype.RestoreVisibilityFromLocalStorage = function () {
  ...
  AnnotationViewer.prototype.SaveVisibilityInLocalStorage = function () {
  ...
  AnnotationViewer.prototype.Initialize = function (parent, itemId) {
  ...
  AnnotationViewer.prototype.RequestGirderImageItem = function (itemId) {
  ...
  AnnotationViewer.prototype.LoadJSONAnnotations = function (annotation_info) {
  ...
  AnnotationViewer.prototype.LoadGirderItemAnnotations = function (data) {
  ...
  AnnotationViewer.prototype.CheckItemDataAccessTools = function (data) {
    // First we have to see if we have write access to the folder containing this item.
    var self = this;
    girder.rest.restRequest({
  ...
  AnnotationViewer.prototype.CheckFolderDataAccessTools = function (data) {
  ...
  AnnotationViewer.prototype.InitializeDefaultToolPanel = function () {
  ...
  AnnotationViewer.prototype.GetDefaultLayerGui = function () {
    var layerGui;
  ...
  AnnotationViewer.prototype.HandleTouchStart = function (event) {
  ...
  AnnotationViewer.prototype.HandleTouchMove = function (event) {
  ...
  AnnotationViewer.prototype.HandleTouchEnd = function (event) {
  ...
  AnnotationViewer.prototype.HandleMouseDown = function (event) {
    if (this.EditingLayerGui) {
      var layer = this.EditingLayerGui.Layer;
  ...
  AnnotationViewer.prototype.HandleMouseUp = function (event) {
    if (this.EditingLayerGui) {
      var layer = this.EditingLayerGui.Layer;
  ...
  AnnotationViewer.prototype.HandleMouseMove = function (event) {
    if (this.EditingLayerGui) {
      var layer = this.EditingLayerGui.Layer;
  ...
  AnnotationViewer.prototype.HandleMouseWheel = function (event) {
    if (this.EditingLayerGui) {
      var layer = this.EditingLayerGui.Layer;
  ...
  AnnotationViewer.prototype.HandleKeyDown = function (event) {
    if (!this.EditingLayerGui) {
      return true;
    }
    var layer = this.EditingLayerGui.Layer;
  ...
  AnnotationViewer.prototype.HandleMouseClick = function (event) {
    if (this.EditingLayerGui) {
  ...
  AnnotationViewer.prototype.SetEditingLayerGui = function (layerGui) {
  ...
  AnnotationViewer.prototype.CheckForIPadPencil = function (event, debug) {
  ...
  SAM.AnnotationViewer = AnnotationViewer;
})();
